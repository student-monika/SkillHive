  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='text-2xl leading-9 md:text-4xl md:leading-[44px] font-bold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      {/* ratings and reviews */}
       ...
       <p className='text-sm'>Course By <span className='text-blue-600 underline'>Monika</span></p>
          ...
          <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
            <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=>toggleSection(index)}>
              <div className='flex items-center gap-2'>
                ...
                <p className='text-sm md:text-default'>{chapter.chapterTitle}</p>
                </div>
      ...
      <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'> 
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 items-center pt-2'>
            <p className='text-gray-800 md:text-4xl tet-2xl font-semibold'>{currency}{(courseData.coursePrice-courseData.discount*courseData.coursePrice/100).toFixed(2)}</p>
