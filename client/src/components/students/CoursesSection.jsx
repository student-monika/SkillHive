...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3'>Discover the top-rated courses across various categories. From coding to design to business and wellness.</p>
